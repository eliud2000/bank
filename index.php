  ...
  <section id="hero" class="clearfix">
    <div class="container" data-aos="fade-up">
      ...
      <div class="hero-info" data-aos="zoom-in" data-aos-delay="100">
        <h2>Bienvenue sur<br><span>Ivoire Finance</span><br> service!</h2>
        <div>
          <a href="forms/employee-login.php" class="btn-get-started scrollto">Connexion Client</a>
          <a href="forms/employee-login.php" class="btn-services scrollto">Connexion Caissière</a>
          <a href="forms/manager-login.php" class="btn-services scrollto">Connexion Manager des Comptes</a>
        </div>
      </div>
    ...
    <section id="about">
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h3>About Us</h3>
          <p>SWIFT is an Indian , public sector banking and financial services statutory body, fostering the nation’s 2.6 trillion-dollar economy and serving the hopes of its vast population.</p>
        </header>
