...
<head>
  ...
  <title>Ivoire Finance | Connexion Gestionnaire </title>
...
<body>
    <nav style="width: 100%; background-color: #009df8; height: 10vh; color: white; padding:10px 10px 10px 10px;"> <center><h2>Connexion Ivoire Finance</h2></center></nav>
  <main>
      ...
      <div class="row">
        ...
        <div class="col-sm-5 login-section-wrapper">
          <div class="login-wrapper my-auto">
            <h1 class="login-title">Bienvenue Gestionnaire!</h1>
