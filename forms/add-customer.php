...
<body>
    ...
    <center id="options">
            ...
            if (isset($_SESSION['empfname'])) {
                echo "<a href='../employee/employee-dashboard.php' class='btn btn-outline-primary'>Acceuil</a>";
                
            }
            

            if (isset($_SESSION['managername'])) {
                echo "<a href='../manager/manager-dashboard.php' class='btn btn-outline-primary'>Acceuil</a>";
             }
           ?>
    </center>
