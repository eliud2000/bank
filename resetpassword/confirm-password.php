...
if (isset($_POST['submit'])) {
    ...
    if ($check_pwd == 0) {
        ...
        if ($change_pwd) {
            ...
            echo "<script>alert('Votre mot de passe a été changé'); </script>";
        ...
        echo "<script>alert('Les mots de passe ne concordent pas!'); </script>";
    }
...
<head>
    ...
    <title>Reintialiser votre mot de passe</title>
    <style>
            ...
            <div class="col-sm-4" id="mainform">
                <center>
                    ...
                    <form class="row g-3" method="post" action="<?php $_SERVER['PHP_SELF']; ?>">
                          ...
                          <input type="submit" name="submit" value="Changer le mot de passe" class="btn btn-primary">
                    </form>    
                </center>
            </div>
            <div class="col-sm-4"></div>
