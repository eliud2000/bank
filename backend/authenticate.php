      ...
      if ($result) {
        ...
        //  $check_password_hash = password_verify($password,$fetch_employee_result['pass']);
          ...
          if ($password) {
            ...
            echo "<script> alert('Wrong Credentials 1!'); window.location.href='../forms/employee-login.php';</script>";

        }else 
          echo "<script> alert('Wrong Credentials 2!'); window.location.href='../forms/employee-login.php';</script>"; 
