  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
         ...
         <h1><a href="../index.php">Ivoire Finance</a></h1> 
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Bienvenue <?php echo $_SESSION['managername']; ?></h2>
          <a href="../backend/manager-logout.php"><h5>Se deconnecter</h5></a>
        </div>
...
<!-----Account Details Section---->
    <section class="inner-page pt-4 m-5">
      <center><h2><b>Dashboard Manager</b></h2></center>
      <div class="container">
          <ul class="nav nav-tabs" id="myTab" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Details de comptes</button>
              </li>
              
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Fonds de transfert</button>
              </li>
              <!--
              <li class="nav-item" role="presentation">
              ...
              <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                  ...
                  <div class="d-flex align-items-start mt-5">
                        <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                <button class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">Trouver un client</button>
                                <button class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false">Ajouter un client</buttona>
                                <button class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false">Supprimer un client</button>
                        </div>
                        <div class="tab-content" id="v-pills-tabContent">
                                <!--Find customer-->
                                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                  <center><h2>Trouver des details client</h2></center>
                                  <form action="" method="post">
                                    <div class="input-group input-group-lg mb-3">
                                      ...
                                      <button class="btn btn-outline-secondary" name="findcustomer" type="submit" id="button-addon2">Trouver des details</button>
                                    </div>
                                  </form>  
                                    <?php
                                ...
                                <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                                      <center><h2><b>Supprimer client</b></h2></center>
                                      <form action="" method="post">
